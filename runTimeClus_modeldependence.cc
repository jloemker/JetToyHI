...
// ./runTimeClus_modeldependencs -hard /dcache/alice/bashof/Pythia/5TeV_pu14/PythiaEventsTune14PtHat132_$fileNumber.pu14 -nev 10000
...
int main (int argc, char ** argv) {
  ...
  TFile *fout = new TFile("JetToyHIResultTimeClus_model.root","RECREATE");
  ...
  {  
    ...
    vector<PseudoJet> particlesSig = sig_selector(particlesMergedAll);// all input particles (PYTHIA/MC)
