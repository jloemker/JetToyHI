...
private :
  ...
  std::vector<std::vector<double>> tau21s_;      // nsubjettiness
  std::vector<std::vector<double>> tau32s_;      // nsubjettiness
...
public :
  ...
  std::vector<std::vector<double>> getTau21s() const { return tau21s_; }
  std::vector<std::vector<double>> getTau32s() const { return tau32s_; }
  ...
  for(fastjet::PseudoJet &jet: fjInputs_)
   {
      if(jet.has_constituents() == false)
      {
         ...
         tau21s_.push_back(vector<double>());
         tau32s_.push_back(vector<double>());
         continue;
      }
	 ...
	 continue;
      ...
      tau32.push_back(tau32_beta2);                                                                    
      */
      tau21s_.push_back(tau21);                                                                         
      tau32s_.push_back(tau32); 
   }
}
